"""
Django settings for MMORPG_ANNOUNCEMENTS project.
...
SECRET_KEY = 'django-insecure-x^9-rnx&o+r#!-mvtzk31k(lj$vt(mn77on#h@(#d4l%s=*#rn'
...
ROOT_URLCONF = 'MMORPG_ANNOUNCEMENTS.urls'
...
WSGI_APPLICATION = 'MMORPG_ANNOUNCEMENTS.wsgi.application'
